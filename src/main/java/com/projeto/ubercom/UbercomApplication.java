...
import com.projeto.ubercom.domain.PagamentoComCartao;
...
public class UbercomApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36372213769865", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("1234234", "4234234"));
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 20:00"), cli1, e2);

		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 12:12"),
				null);
